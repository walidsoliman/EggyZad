...
//
         ...
         //  alert(error.responseText)
                $("#fad").text(error.responseText);

               $("#fad").addClass("alert-danger");
                $("#fad").fadeIn();
        ...
        <div class="container">
            ...
            <div id="listing" class="content list">
                ...
                <div id="side-right">
                    ...
                    <div id="price" class="round i-shadow">
                        ...
                        <span class="long-price-fix price-f " id="">
                            $</span>
                        <span class="long-price-fix price-f " id="max">


                            {{$auc->current_max_Price}}</span>
                        ...
                        <div class="sc-block body">
                            <div class="inside">
                                ...
                                @if(Auth::check())
                                        ...
                                        @can('bid', $auc)
                                            <form method="post" action="{{"/Bid/".$auc->id}}" name="register" id="Bidform"  enctype="multipart/form-data"   role="form"  style="margin-bottom: 50px">
                                                @csrf
                                            ...
                                            <div   id="fad" class=" " style="font-size: large; padding: 10px; line-height:25px; margin-top: 20px"  >  </div>

                                        @endcan
                                            @cannot('bid', $auc)

                                                <div  class="alert-danger " style="font-size: large; padding: 10px; line-height:25px"  >Youe can't Bid More Than 5 times for every Auction In Free Account  </div>
                                            @endcannot
                                        <br>
